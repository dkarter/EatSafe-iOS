//
//  InspectionsTableViewController.m
//  SafeToEat
//
...
{
    [super viewDidLoad];
    self.inspectionData = [[NSArray alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = self.inspectionData[indexPath.row][@"date"];
    //cell.detailTextLabel.text = [item objectForKey:@"results"];
    // Configure the cell...
    // self.inspectionData[indexPath.row][@""];
    return cell;
}
